/* @ts-self-types="./query_engine_wasm.d.ts" */
...
export class QueryEngine {
    ...
    execute(sql) {
        ...
        const ret = wasm.queryengine_execute(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
    ...
    register_csv(name, data) {
        ...
        const ret = wasm.queryengine_register_csv(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    table_count() {
        const ret = wasm.queryengine_table_count(this.__wbg_ptr);
        return ret >>> 0;
    }
}
 ...
 * @returns {any}
 */
export function infer_schema(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.infer_schema(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./query_engine_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('query_engine_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
